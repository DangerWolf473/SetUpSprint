...
<body>
    ...
    <section class="pr-main container">
        ...
        <div class="product-detail-img">
            <img src="../assets/images/<?php echo $product['ProductName'] ?>.jpg" alt="product" class="prd-img" />
        </div>
        <div class="product-info">
            ...
            <div class="pr-detail-price">
                ...
                if ($product['SpecialPrice']!=0){
                        ...
                        echo"<div class='price-d'>".$product["SpecialPrice"]." PKR</div>";
                        echo "<div class='price-bd'>".$product['OldPrice']." PKR</div>";
                        echo"<div class='discount'><p>".$product['Discount']." PKR</p></div>" ;
                        echo "</div>";
                    } else echo "<div class='price-d'>".$product['OldPrice']." PKR</div>";

...
if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
    ...
    foreach ($products as $product) {
        ...
        if ($product['SpecialPrice'] != 0) {
            ...
            $subtotal += $product['OldPrice'] * (int)$products_in_cart[$ID];
        }
?>
        ...
        <div class="cart-item">
            <div class="left-cart-item">
                ...
                <div class="cart-item-info">
                    ...
                    <h2><?php echo ($product['SpecialPrice'] != 0) ? $product['SpecialPrice'] : $product['OldPrice'] ?> PKR</h2>
                </div>
            </div>
            <div class="right-cart-item">
                <div class="cart-quantity">
                    <a href="../config/updateCartItem.php?productID=<?php echo $ID ?>&action=inc">+</a>
                    <div id="qt-<?php echo $ID ?>"><?php echo $products_in_cart[$ID] ?></div>
                    <a href="../config/updateCartItem.php?productID=<?php echo $ID ?>&action=dec">-</a>
                </div>
